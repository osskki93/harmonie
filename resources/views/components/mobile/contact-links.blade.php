@php
    $wrapperClass = $wrapperClass ?? 'contact-actions';
@endphp

<div class="{{ $wrapperClass }}" aria-label="{{ __('site.mobile.contact_links') }}">
    <a class="contact-icon-btn" href="https://wa.me/41772571313" aria-label="{{ __('site.mobile.whatsapp_label') }}" target="_blank" rel="noopener noreferrer">
        <svg class="contact-icon-fill" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" aria-hidden="true">
    ...
    <a class="contact-icon-btn" href="mailto:mllopoliver21@gmail.com" aria-label="{{ __('site.mobile.email_label') }}">
        <svg class="contact-icon" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
